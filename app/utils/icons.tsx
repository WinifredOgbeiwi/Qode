...
export const Linkedin02Icon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={32} height={32} color={"#ffffff"} fill={"none"} {...props}>
...
export const MailAtSign01Icon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={32} height={32} color={"#ffffff"} fill={"none"} {...props}>
...
export const ArrowRightDoubleIcon = (props: React.SVGProps<SVGSVGElement>) => (
